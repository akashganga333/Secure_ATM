...
def getaccno(accno):
    ...
    imagePaths = list(paths.list_images(f"C:\\Users\\newha\\OneDrive\\Desktop\\30-12-21\\Secure_Atm\\users_face/{name}"))
    print(imagePaths)
    ...
    print(data)
    with open('C:\\Users\\newha\\OneDrive\\Desktop\\30-12-21\\Secure_Atm\\ATM\\Liveness_detection\\encoded_faces.pickle', 'wb') as file:
        file.write(pickle.dumps(data))
        
    # from Face_Recognization import recognize_faces
    #Liveness_demo.launch_face_scan()
...
# # grab the paths to the input images in our dataset
# print('[INFO] quantifying faces...')
# imagePaths = list(paths.list_images(f"C:\\Users\\Akash\\Desktop\\Secure_Atm\\users_face/{name}"))
